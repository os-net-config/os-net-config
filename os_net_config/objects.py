...
class _BaseOpts(object):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 onboot=True, domain=None, dns_options=None):
    ...
    def base_opts_from_json(json, include_primary=True):
        ...
        dns_options = json.get('dns_options')
        ...
        if include_primary:
            ...
            return (use_dhcp, use_dhcpv6, addresses, routes, rules, mtu,
                    ...
                    dns_servers, nm_controlled, onboot, domain, dns_options)
...
class Interface(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 nic_mapping=None, persist_mapping=False, defroute=True,
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, ethtool_opts=None,
                 hotplug=False, linkdelay=None, ovs_extra=[]):
        addresses = addresses or []
        routes = routes or []
        rules = rules or []
        dns_servers = dns_servers or []
...
class Vlan(_BaseOpts):
    ...
    def __init__(self, device, vlan_id, use_dhcp=False, use_dhcpv6=False,
                 ...
                 dns_options=None, ovs_options=None, ovs_extra=None):
        addresses = addresses or []
        routes = routes or []
        rules = rules or []
        dns_servers = dns_servers or []
...
class OvsInterface(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 nic_mapping=None, persist_mapping=False, defroute=True,
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, hwaddr=None,
                 ovs_extra=[]):
        addresses = addresses or []
        routes = routes or []
        rules = rules or []
        ...
        super(OvsInterface, self).__init__(
            ...
            nic_mapping, persist_mapping, defroute,
            dhclient_args, dns_servers,
            nm_controlled, onboot, domain, dns_options)
        self.hwaddr = hwaddr
        self.ovs_extra = format_ovs_extra(self, ovs_extra)
...
class OvsBridge(_BaseOpts):
    ...
    def from_json(json):
        ...
        (use_dhcp, use_dhcpv6, addresses, routes, rules, mtu, nic_mapping,
         ...
         nm_controlled, onboot, domain,
         dns_options) = _BaseOpts.base_opts_from_json(
...
class LinuxBridge(_BaseOpts):
    ...
    def from_json(json):
        ...
        (use_dhcp, use_dhcpv6, addresses, routes, rules, mtu, nic_mapping,
         ...
         onboot, domain, dns_options) = _BaseOpts.base_opts_from_json(
             json, include_primary=False)
...
class OvsTunnel(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 nic_mapping=None, persist_mapping=False, defroute=True,
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, tunnel_type=None,
...
class OvsPatchPort(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 nic_mapping=None, persist_mapping=False, defroute=True,
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, bridge_name=None,
...
class OvsDpdkPort(_BaseOpts):
    ...
    def from_json(json):
        ...
        (use_dhcp, use_dhcpv6, addresses, routes, rules, mtu, primary,
         nic_mapping, persist_mapping, defroute, dhclient_args,
         dns_servers, nm_controlled,
         onboot, domain, dns_options) = _BaseOpts.base_opts_from_json(json)
...
class SriovVF(_BaseOpts):
    ...
    def __init__(self, device, vfid, use_dhcp=False, use_dhcpv6=False,
                 ...
                 defroute=True, dhclient_args=None, dns_servers=None,
                 nm_controlled=False, onboot=True, domain=None,
                 dns_options=None, vlan_id=0, qos=0, spoofcheck=None,
                 trust=None, state=None, macaddr=None, promisc=None,
                 min_tx_rate=0, max_tx_rate=0, ethtool_opts=None,
                 ovs_extra=[]):
        addresses = addresses or []
        routes = routes or []
        rules = rules or []
        ...
        # When autoprobe is disabled, the VFs will not be bound with the
        # default netdev drivers and the interface names could not be read.
        # In NIC partitioning use cases the interface  name of the VFs needs
        # to be read for further configuration. Hence in NIC partitioning
        # scenario, the default driver is identified and bound with the VFs
        # involved in host networking.
        # If the VF is attached to a DPDK port, then the below driverctl
        # override would be overridden again later.
        # When autoprobe is enabled, the default driver would be already bound
        # with the VF, and hence no override happens.
        # During update or os-net-config re-run, the device could be already
        # bound with vfio-pci and the driver overriding is avoided.
...
class SriovPF(_BaseOpts):
    ...
    def __init__(self, name, numvfs, use_dhcp=False, use_dhcpv6=False,
                 ...
                 defroute=True, dhclient_args=None, dns_servers=None,
                 nm_controlled=False, onboot=True, domain=None,
                 dns_options=None, members=None, promisc=None,
                 link_mode='legacy', ethtool_opts=None, vdpa=False,
                 steering_mode=None, drivers_autoprobe=True):
        addresses = addresses or []
        routes = routes or []
        rules = rules or []
        dns_servers = dns_servers or []
...
class ContrailVrouter(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 nic_mapping=None, persist_mapping=False, defroute=True,
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, members=None):
        addresses = addresses or []
    ...
    def from_json(json):
        ...
        (_use_dhcp, _use_dhcpv6, _addresses, _routes, _rules, _mtu, _primary,
         ...
         _domain, _dns_options) = opts = _BaseOpts.base_opts_from_json(json)
        members = _update_members(json, nic_mapping, persist_mapping)
...
class ContrailVrouterDpdk(_BaseOpts):
    ...
    def __init__(self, name, use_dhcp=False, use_dhcpv6=False, addresses=None,
                 ...
                 dhclient_args=None, dns_servers=None, nm_controlled=False,
                 onboot=True, domain=None, dns_options=None, members=None,
                 bond_mode=None, bond_policy=None, driver=None,
...
class RemoveNetDevice(object):
    ...
    def __init__(self, remove_name, remove_type,
                 nic_mapping=None):
        """Initialize a RemoveNetDevice object.

        :param remove_name: Device name (can be abstract name like 'nic1' or
                        SR-IOV pattern like 'sriov:nic4:7')
        :param remove_type: Device type (must be from remove_type schema)
        :param nic_mapping: Optional mapping dictionary for abstract names
        """
        # Check if remove_name has SR-IOV pattern "sriov:pf_name:vf_id"
        if remove_name.startswith('sriov:'):
            name = self.resolve_sriov_name(remove_name, nic_mapping)
        else:
            name = self.get_mapped_nic(remove_name, nic_mapping)
    ...
    @staticmethod
    def get_mapped_nic(remove_name, nic_mapping):
        # Apply NIC mapping if available
        mapped_nic_names = mapped_nics(nic_mapping)
        if remove_name in mapped_nic_names:
            return mapped_nic_names[remove_name]
        else:
            return remove_name

    @staticmethod
    def resolve_sriov_name(remove_name, nic_mapping):
        device = remove_name.split(":")
    ...
    def from_json(json):
        ...
        """
        remove_name = _get_required_field(json,
