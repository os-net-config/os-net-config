...
class IfcfgNetConfig(os_net_config.NetConfig):
    ...
    def enumerate_ifcfg_route_changes(self, old_routes, new_routes):
        ...
        :param old_routes: contents of existing interface route file
        :param new_routes: contents of replacement interface route file
    ...
    def enumerate_ifcfg_rule_changes(self, old_rules, new_rules):
        ...
        :param old_rules: contents of existing interface route rule file
        :param new_rules: contents of replacement interface route rule file
    ...
    def apply(self, cleanup=False, activate=True, config_rules_dns=True):
        ...
        if activate:
            ...
            for iface in set_sysctls:
                # In order to make sure that the sysctls are set we run ifup
                # even if interface is up
                self.ifup(iface)
